...
/*
    按键的扫描周期，单位：ms
    用在定时器中断，注意数值不能超过变量的最大值
*/
#define RF_KEY_SCAN_CIRCLE_TIMES (10) // 收到的一帧数据可能有40ms，加上每帧间隔10ms，这里的扫描间隔要更大
